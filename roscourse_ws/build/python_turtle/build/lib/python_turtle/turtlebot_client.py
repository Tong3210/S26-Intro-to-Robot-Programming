...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter(
            'turtleColor',
            'red',
            ParameterDescriptor(description='Initial turtle color on startup')
        )
        self.declare_parameter(
            'penSize',
            2,
            ParameterDescriptor(description='Initial turtle pen size on startup')
        )
        ...
        #### call setColor service so server stores the color too ####

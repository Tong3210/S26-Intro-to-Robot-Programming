...
class TurtlebotServer(Node):
    ...
    def driving_timer_cb(self):
        ...
        new_x = self.turtle.turtle_pose.position.x + \
                self.vel_x * self.sim_interval * math.cos(yaw) - \
                self.vel_y * self.sim_interval * math.sin(yaw)
        new_y = self.turtle.turtle_pose.position.y + \
                self.vel_x * self.sim_interval * math.sin(yaw) + \
                self.vel_y * self.sim_interval * math.cos(yaw)
